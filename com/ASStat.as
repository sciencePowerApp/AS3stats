package com.xperiment.AS3stats
{
	import flash.utils.flash_proxy;
	import flash.utils.Proxy;
    import com.xperiment.AS3stats.ASStatc.*;
	...
	dynamic public  class ASStat extends Proxy  
	{
	   ...
	   public static function seq(min:Number, max:Number, length:uint, func:*=null):Array
		...
		{
			var nrow:int=ASStat.rows(arr) - 1;
			var res:Array = new Array(nrow)
		...
		public static function create(rows:*, cols:*, func:*=null):*
		{
		...
		public static function zeros(rows:*, cols:*=null):*
		{
		...
		public static function ones(rows:*, cols:*=null):*
		{
			if(!isNumber(cols)) cols=rows;
